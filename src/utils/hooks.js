...
export const useNavigation = () => {
  ...
  const allTabs = [
    ...
    { id: 'photos', label: 'Photos', icon: '📸', path: '/photos', description: 'Photo gallery with location' },
    ...
    { id: 'calendar', label: 'Calendar', icon: '📅', path: '/calendar', description: 'Important dates and events' },
